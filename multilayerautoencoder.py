...
class MultilayerAutoencoder:
    def __init__(self, inputs, hidden_num, layers_num=2, enc_cell=None, dec_cell=None, optimizer=None, conditioned=None):
        '''
...
if __name__ == '__main__':
    ...
    hidden_num = 2500
    batch_size = 30
    data_generator = DataHandler(DATASET,
                                 num_frames=maxtime, batch_size=batch_size)
    ...
    ae = MultilayerAutoencoder(inputs, hidden_num, optimizer=rmsOpti, conditioned=False)
